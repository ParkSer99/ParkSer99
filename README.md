...
![js](https://img.shields.io/badge/Node.js-43853D?style=flat&logo=node.js&logoColor=white)
...
**"항상 사용자의 입장에서 생각하며 더 나은 인터랙션을 개발하는 것에 중점을 두는 개발자 입니다."**
...
|:---|:---|:---|
| [**AGV Fleet Core**](https://github.com/Intel-Edge-9s/AMR_Fleet_Core) | **다중 로봇 통합 관제 시스템**<br>• A* 알고리즘 기반 경로 최적화 및 간섭 예외 처리<br>• 온보딩 주행 코드 작성 | `QT`, `C++`, `Python`<br>`MariaDB`, `ROS2` |
...
![Arduino](https://img.shields.io/badge/OpenCR-00979D?style=flat&logo=arduino&logoColor=white)
