...
|:---|:---|:---|
| [**AGV Fleet Core**](https://github.com/Intel-Edge-9s/AGV_Fleet_Core) | **다중 로봇 통합 관제 시스템**<br>• A* 알고리즘 기반 경로 최적화 및 간섭 예외 처리<br>• 온보딩 주행 코드 작성 | `QT`, `C++`, `Python`<br>`MariaDB`, `ROS2` |
